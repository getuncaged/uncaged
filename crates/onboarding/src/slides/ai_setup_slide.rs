...
const WARP_AGENT_FEATURES: &[&str] = &[
    ...
    "Bring your own API key — Anthropic, OpenAI, and more",
    "Point it at a local runtime like LM Studio or Ollama",
    "No account, no subscription — you own the connection",
];
...
/// The "Choose your AI setup" slide. Forks between Uncaged's built-in agent
/// (powered by the user's own model — an API key or a local runtime) and
/// third-party CLI agents (Claude Code, Codex, Gemini).
...
impl AiSetupSlide {
    ...
    // The right panel reuses existing bundled assets that match each choice: the
    // agent experience for the built-in agent and the CLI-agent toolbar for
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let subtitle = FormattedTextElement::from_str(
            "Choose how Uncaged connects to your model.",
    ...
    fn render_warp_agent_card(
        ...
        let header_row = {
            let label = appearance
                .ui_builder()
                .paragraph("Uncaged's built-in agent")
                .with_style(UiComponentStyles {
                    font_size: Some(16.),
        ...
        let description = FormattedTextElement::from_str(
            "A state of the art agent harness, powered by your own model.",
            appearance.ui_font_family(),
            14.,
        )
    ...
    fn render_third_party_card(
        ...
        let label = appearance
            .ui_builder()
            .paragraph("Third-party CLI agents")
            .with_style(UiComponentStyles {
                font_size: Some(16.),
                font_weight: Some(Weight::Semibold),
