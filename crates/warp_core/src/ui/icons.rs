...
pub enum Icon {
    ...
    OpenAILogo,
    XLogo,
    // Uncaged provider brand marks (Connect a model gallery).
    OllamaLogo,
    LmStudioLogo,
    OpenRouterLogo,
    GroqLogo,
    ...
    Oz,
    OzCloud,
    /// The Uncaged AI reply mark: the ember `❯` prompt caret, shown beside an
    /// AI response when the connected provider has no logo of its own.
    AiCaret,
    Conversation,
    Prompt,
    Grid,
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::LmStudioLogo => "bundled/svg/lm-studio.svg",
            Icon::OpenRouterLogo => "bundled/svg/openrouter.svg",
            Icon::GroqLogo => "bundled/svg/groq.svg",
            Icon::DeepSeekLogo => "bundled/svg/deepseek.svg",
            Icon::MistralLogo => "bundled/svg/mistral.svg",
            Icon::TogetherLogo => "bundled/svg/together.svg",
