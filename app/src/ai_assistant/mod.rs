//! AI Assistant has since been renamed to "Uncaged AI" in the product.
...
pub const AI_ASSISTANT_FEATURE_NAME: &str = "Uncaged AI";
pub const ASK_AI_ASSISTANT_TEXT: &str = "Ask Uncaged AI";
