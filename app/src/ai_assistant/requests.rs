...
/// Tracks the current request status for making Uncaged AI requests against server.
...
impl Requests {
    ...
    /// Starts a Uncaged AI request against the server with the given request prompt.
