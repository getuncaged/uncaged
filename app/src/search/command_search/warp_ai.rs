...
const OPEN_WARP_AI_ITEM_BODY_TEXT: &str = "Ask Uncaged AI for command suggestions";
const TRANSLATE_WITH_WARP_AI_ITEM_BODY_TEXT: &str = "Translate into shell command using Uncaged AI";
...
impl SearchItem for WarpAISearchItem {
    ...
    fn render_icon(
        ...
        // Since the Uncaged AI logo color is hardcoded, let's find the best
    ...
    fn accessibility_label(&self) -> String {
        format!("Uncaged AI: {}", self.item_body_text())
    }
}

/// The Uncaged AI data source provides two different types of results:
/// - synchronous: the synchronous result provided by this data source is a
///   single item that opens/translates using Uncaged AI when selected.
