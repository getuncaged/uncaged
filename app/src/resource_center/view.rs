...
// Footer icons
const DOCS_SVG_PATH: &str = "bundled/svg/book-open.svg";
const SLACK_SVG_PATH: &str = "bundled/svg/conversation.svg";
...
impl ResourceCenterFooterItem {
    pub fn ui_label(&self) -> &'static str {
        match self {
            ...
            ResourceCenterFooterItem::Slack => crate::brand::COMMUNITY_LABEL,
