    ...
    let get_started = FeatureSectionData {
        ...
        items: vec![
            ...
            FeatureItem::new(
                ...
                "Access all of Uncaged via the keyboard.",
                Tip::Action(TipAction::CommandPalette),
                ctx,
            ),
            FeatureItem::new(
                "Set your theme",
                "Make Uncaged your own by choosing a theme.",
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                description: "Set up Uncaged to honor your PS1 setting",
                url: crate::brand::README_URL,
                button_label: "View documentation",
            },
            ContentItem {
                title: "Integrate Uncaged with your IDE",
                description: "Configure Uncaged to launch from your most used development tools",
                url: crate::brand::README_URL,
                button_label: "View documentation",
            },
            ContentItem {
                title: "Get the most out of Uncaged",
                description: "Tips and tricks for power users",
                url: crate::brand::HOME_URL,
