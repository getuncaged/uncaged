...
define_settings_group!(AISettings, settings: [
    ...
    aws_bedrock_credentials_enabled: AwsBedrockCredentialsEnabled {
        ...
        description: "Whether Uncaged should use your local AWS credentials for Bedrock-enabled requests.",
    }
    ...
    gemini_enterprise_credentials_enabled: GeminiEnterpriseCredentialsEnabled {
        ...
        description: "Whether Uncaged should route eligible requests through your workspace's Gemini Enterprise Google Cloud project.",
    }
    ...
    warp_drive_context_enabled: WarpDriveContextEnabled {
        ...
        description: "Whether workspace context is included in AI requests.",
    }
    ...
    can_use_warp_credits_for_fallback: CanUseWarpCreditsForFallback {
        ...
        description: "Whether Uncaged credits can be used as a fallback for user-provided models.",
    }
    ...
    auto_handoff_on_sleep_enabled: AutoHandoffOnSleepEnabled {
        ...
        description: "Whether Uncaged automatically hands off local agent conversations to cloud when the computer is about to sleep.",
    }
...
impl AISettings {
    ...
    pub fn is_any_ai_enabled(&self, app: &AppContext) -> bool {
        ...
        // Uncaged: a configured local engine makes AI available with no
        // Warp account (free-for-all, no login required).
        *self.is_any_ai_enabled
            && (crate::uncaged::engine_active() || !is_anonymous_or_logged_out)
