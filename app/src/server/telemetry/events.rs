...
pub enum TelemetryEvent {
    ...
    /// Opened legacy Uncaged AI.
    OpenedWarpAI {
        source: OpenedWarpAISource,
    },
    /// Issued legacy Uncaged AI request.
    WarpAIRequestIssued {
    ...
    // Toggled the legacy Uncaged AI side panel.
    ToggleWarpAI {
        opened: bool,
    },
...
impl TelemetryEventDesc for TelemetryEventDiscriminants {
    ...
    fn name(&self) -> &'static str {
        match self {
            ...
            Self::OpenedWarpAI => "Opened Uncaged AI",
            Self::WarpAIRequestIssued => "Uncaged AI Request Issued",
            Self::WarpAIAction => "Uncaged AI Action",
            Self::UsedWarpAIPreparedPrompt => "Used Uncaged AI Prepared Prompt",
            Self::WarpAICharacterLimitExceeded => "Uncaged AI Character Limit Exceeded",
            ...
            Self::ToggleWarpAI => "Toggle Uncaged AI",
    ...
    fn description(&self) -> &'static str {
        match self {
            ...
            Self::OpenedWarpAI => "Activated Uncaged AI",
            Self::WarpAIRequestIssued => "Issued a question to Uncaged AI",
            Self::WarpAIAction => "Executed a Uncaged AI action: Restart, Copy, Insert into terminal",
            Self::UsedWarpAIPreparedPrompt => {
                "Used one of the Warp-provided prompts, like \"Show examples\""
            }
            Self::WarpAICharacterLimitExceeded => {
                "Attempted to ask a question longer than 1k chars to Uncaged AI"
            }
            ...
            Self::InputAskWarpAI => "Clicked \"Ask Uncaged AI\" from the Input Editor's context menu",
            ...
            Self::ToggleWarpAI => {
                "Toggled Uncaged AI--an AI assistant to help you debug errors, look up forgotten commands and more"
            }
            ...
            Self::AutoGenerateMetadataSuccess => {
                "Successfully generated metadata for a workflow using Uncaged AI"
            }
            Self::AutoGenerateMetadataError => {
                "Failed to generate metadata for a workflow using Uncaged AI"
            }
