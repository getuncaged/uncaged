...
//!   cards ("Install Uncaged's SSH extension" / "Continue without installing"),
        ...
        let buttons = ctx.add_typed_action_view(|_| {
            KeyboardNavigableButtons::new(vec![
                rich_navigation_button(
                    "Install Uncaged's SSH extension".to_string(),
                    Some(
                        "Install Uncaged's extension to enable agent features like file browsing, \
