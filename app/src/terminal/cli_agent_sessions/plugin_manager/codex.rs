...
impl CliAgentPluginManager for CodexPluginManager {
    ...
    fn install_success_message(&self) -> &'static str {
        "Uncaged plugin installed. Please restart Codex to activate."
    }

    fn update_success_message(&self) -> &'static str {
        "Uncaged plugin updated. Please restart Codex to activate."
    }
...
static PLUGIN_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> =
    LazyLock::new(|| PluginInstructions {
        title: "Install Uncaged Plugin for Codex",
        subtitle: "Run the following commands, then restart Codex.",
        steps: &[
            PluginInstructionStep {
                description: "Add the Uncaged plugin marketplace repository",
                command: "codex plugin marketplace add warpdotdev/codex-warp",
                executable: true,
                link: None,
            },
            PluginInstructionStep {
                description: "Install the Uncaged plugin",
...
static NATIVE_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Enable Uncaged Notifications for Codex",
        subtitle: "Update Codex to the latest version, then enable in-focus notifications so Uncaged can display them while you work.",
        steps: &[
            PluginInstructionStep {
...
static PLUGIN_UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Update Uncaged Plugin for Codex",
        subtitle: "Run the following commands, then restart Codex.",
        steps: &[
            PluginInstructionStep {
            ...
            PluginInstructionStep {
                description: "Reinstall the Uncaged plugin",
                command: "codex plugin add warp@codex-warp",
                executable: true,
                link: None,
            },
