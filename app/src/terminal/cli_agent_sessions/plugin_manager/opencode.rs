...
static INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Install Uncaged Plugin for OpenCode",
        subtitle:
            "Add the Uncaged plugin to your OpenCode configuration, then restart OpenCode.",
        steps: &[
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Update Uncaged Plugin for OpenCode",
