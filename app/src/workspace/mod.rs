...
pub fn init(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        .with_enabled(|| false) // Uncaged: Warp Drive is disabled; hide the binding.
        .with_group(bindings::BindingGroup::Navigation.as_str())
        .with_context_predicate(id!("Workspace") & id!(flags::ENABLE_WARP_DRIVE))
    ...
    // Uncaged has no accounts — no "Log out" command.
    ...
    // Oz and Uncaged Control CLI install/uninstall actions (macOS only)
    #[cfg(target_os = "macos")]
    {
        app.register_editable_bindings([
            EditableBinding::new(
                "workspace:install_cli",
                "Install Uncaged CLI command",
        ...
        if FeatureFlag::WarpControlCli.is_enabled() {
            app.register_editable_bindings([
                EditableBinding::new(
                    ...
                    "Install Uncaged Control CLI command",
                ...
                EditableBinding::new(
                    ...
                    "Uninstall Uncaged Control CLI command",
    ...
    app.register_editable_bindings([
        ...
        // two mac menu items for AM vs Uncaged AI since they are mutually exclusive.
        .with_custom_action(CustomAction::NewAgentModePane),
    ]);
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            BindingDescription::new("Open Settings: About")
                .with_custom_description(bindings::MAC_MENUS_CONTEXT, "About Uncaged"),
