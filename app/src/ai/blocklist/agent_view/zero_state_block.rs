...
const CLOUD_AGENT_DOCS_URL: &str = crate::brand::README_URL;
const OZ_UPDATES_SECTION_HEADER: &str = "What's new in Uncaged";
...
impl View for AgentViewZeroStateBlock {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let header_props = if self.origin.is_cloud_agent() {
            ...
            HeaderProps {
                title: "New Uncaged agent conversation".into(),
                description: AgentViewDescription::PlainText(vec![local_description.into()]),
                icon: crate::brand::design::AGENT,
            }
        };
            ...
            Shrinkable::new(
                ...
                Clipped::new(
                    Align::new(
                        ...
                        .on_click(|_, app, _| {
                            const CHANGELOG_URL: &str = crate::brand::README_URL;
