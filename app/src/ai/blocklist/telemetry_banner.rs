...
const TITLE_NEW_USERS: &str = "Help improve Uncaged.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve Uncaged's AI capabilities. You can opt out any time.";
const PRIVACY_URL: &str = crate::brand::HOME_URL;
