...
//!
//! Opened as a side-pane from the agent settings page when the user clicks
        ...
        let routing_type_copy = FormattedText::new([
            FormattedTextLine::Line(vec![
                ...
                FormattedTextFragment::plain_text(
                    " routing chooses a model based on Uncaged's classification of the task's difficulty.",
                ),
            ]),
            FormattedTextLine::Line(vec![
