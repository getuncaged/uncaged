...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        ...
        AgentTip {
            description: "<keybinding> to open the Command Palette and access Uncaged actions and shortcuts.".to_string(),
            link: Some(crate::brand::README_URL.to_string()),
        ...
        AgentTip {
            description: "`@` to add context from files, blocks, or command output to your prompt.".to_string(),
            link: Some(crate::brand::README_URL.to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            description: "`/open-mcp-servers` to view and manage your configured MCP servers.".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::Mcp,
