          ...
          warp-terminal-experimental = rustPlatform.buildRustPackage {
            ...
            postInstall =
              ...
              ''
                ...
                install -Dm644 app/channels/oss/dev.uncaged.WarpOss.desktop \
                  "$out/share/applications/dev.uncaged.WarpOss.desktop"
                substituteInPlace "$out/share/applications/dev.uncaged.WarpOss.desktop" \
                ...
                for size in 16x16 32x32 64x64 128x128 256x256 512x512; do
                  ...
                  if [ -f "$icon" ]; then
                    install -Dm644 "$icon" \
                      "$out/share/icons/hicolor/$size/apps/dev.uncaged.WarpOss.png"
                  fi
                done
